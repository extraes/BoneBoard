...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
    {
        ...
        MessageCreatedEvent =           async (c, a) => { Logger.Put(GetType().FullName + " was informed of a message creation"); if (!DontPropagate.Contains(a)) await MessageCreated(c, a); else Logger.Put("That message's creation was blocked from propagation");        };
