...
file static class ReflectionHelper
{
    ...
    public static MethodInfo GetMethod(string name) => typeof(SkModuleBase).GetMethod(name, EVENT_FLAGS) ?? throw new MissingMethodException(name);
}
