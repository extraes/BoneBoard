...
- if you want Stargrid to work, you'll need to install the '[Twemoji-Mozilla](https://github.com/mozilla/twemoji-colr/releases)' font (for emojis), alongside
  whatever font you have in the config file (default is 'Comfortaa')
